...
class WorldQuantBrain:
    ...
    def get_check_submission(self, alpha_id):
        while True:
            result = self.session.get(
                "https://api.worldquantbrain.com/alphas/" + alpha_id + "/check"
            )
    ...
    def get_alphas(
        self, start_date, end_date, sharpe_th, fitness_th, region, alpha_num, usage
    ):
        next_alphas = []
        decay_alphas = []
        # 3E large 3C less
        ...
        for i in range(0, alpha_num, 100):
            print(i)
            url_e = (
                "https://api.worldquantbrain.com/users/self/alphas?limit=100&offset=%d"
                % (i)
                + "&status=UNSUBMITTED%1FIS_FAIL&dateCreated%3E=2025-"
                + start_date
                + "T00:00:00-04:00&dateCreated%3C2025-"
                + end_date
                + "T00:00:00-04:00&is.fitness%3E"
                + str(fitness_th)
                + "&is.sharpe%3E"
                + str(sharpe_th)
                + "&settings.region="
    ...
    def group_factory(self, op, field, region):
        ...
        chn_group_2 = [
            ...
            "sta2_top2000_fact4_c50",
            "sta2_top3000_fact3_c20",
        ]

        chn_group_7 = [
            "oth171_region_sector_long_d1_sector",
            "oth171_region_sector_short_d1_sector",
            "oth171_sector_long_d1_sector",
            "oth171_sector_short_d1_sector",
        ]
        ...
        twn_group_8 = [
            "oth455_relation_n2v_p50_q200_w1_pca_fact1_cluster_20",
        ...
        usa_group_5 = [
            "anl52_2000_backfill_d1_05c",
            "anl52_3000_d1_05c",
            "anl52_3000_backfill_d1_02c",
            "anl52_3000_backfill_d1_5c",
            "anl52_3000_backfill_d1_05c",
            "anl52_3000_d1_5c",
        ]
        ...
        usa_group_8 = [
            "oth455_competitor_n2v_p10_q50_w1_kmeans_cluster_10",
        ...
        asi_group_1 = [
            ...
            "sta1_minvol1mc50",
            "sta1_minvol1mc20",
            "sta1_minvol1m_normc20",
            "sta1_minvol1m_normc50",
        ]

        asi_group_8 = [
            "oth455_partner_roam_w3_pca_fact1_cluster_5",
        ...
        jpn_group_2 = [
            "sta2_top2000_jpn_513_top2000_fact3_c20",
            "sta2_all_jpn_513_all_fact1_c5",
            "sta2_allfactor_jpn_513_9",
            "sta2_all_jpn_513_all_fact1_c10",
        ]

        jpn_group_8 = [
            "oth455_customer_n2v_p50_q50_w5_kmeans_cluster_10",
        ...
        jpn_group_13 = [
            ...
            "pv13_10_minvol_1m_sector",
            "pv13_10_f3_g2_minvol_1m_sector",
            "pv13_all_delay_1_parent",
            "pv13_all_delay_1_level",
        ]
        ...
        kor_group_2 = [
            ...
            "sta2_top2000_xjp_513_top2000_fact2_c50",
            "sta2_all_xjp_513_all_fact4_c50",
            "sta2_all_xjp_513_all_fact4_c5",
        ]

        kor_group_8 = [
            "oth455_relation_n2v_p50_q200_w3_pca_fact3_cluster_5",
        ...
        eur_group_8 = [
            "oth455_relation_n2v_p50_q200_w3_pca_fact1_cluster_5",
        ...
        glb_group_13 = [
            "pv13_10_f2_g3_sector",
            "pv13_2_f3_g2_sector",
            "pv13_2_sector",
            "pv13_52_all_delay_1_sector",
        ]
        ...
        glb_group_8 = [
            "oth455_relation_n2v_p10_q200_w5_kmeans_cluster_5",
        ...
        amr_group_13 = [
            ...
            "pv13_hierarchy_min2_600_sector",
            "pv13_r2_min2_sector",
            "pv13_h_min20_600_sector",
        ]
        ...
        amr_group_8 = [
            "oth455_relation_roam_w1_pca_fact2_cluster_10",
    ...
    def load_task_pool(
        self, alpha_list: list, batch_size: int = 10, concurrent_batches: int = 10
    ) -> list:
