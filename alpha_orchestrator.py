...
class ModelFleetManager:
    ...
    def __init__(self, ollama_url: str = "http://localhost:11434"):
        ...
        self.model_fleet = [
            ModelInfo("deepseek-r1:8b", 5200, 1, "DeepSeek-R1 8B - Preferred default reasoning model"),
            ModelInfo("llama3.2:3b", 2048, 2, "Llama 3.2 3B - Stable fallback (low VRAM)"),
            # Intentionally keep a much smaller reasoning fallback and an emergency tiny model
            ModelInfo("deepseek-r1:1.5b", 1100, 3, "DeepSeek-R1 1.5B - Small reasoning fallback"),
...
class AlphaOrchestrator:
    ...
    def run_alpha_submitter(self, batch_size: int = 5):
        ...
        try:
            ...
            result = subprocess.run([
                sys.executable, submitter_script,
